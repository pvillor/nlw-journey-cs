...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The date you selected for the activity is not between your travel period..
        /// </summary>
        public static string DATE_NOT_BETWEEN_TRAVEL_PERIOD {
            get {
                return ResourceManager.GetString("DATE_NOT_BETWEEN_TRAVEL_PERIOD", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to End date must be equal to or later than Start date..
        /// </summary>
